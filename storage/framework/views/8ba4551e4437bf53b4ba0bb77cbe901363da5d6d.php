    ...
    <div class="row" style="padding:10px">
       ...
       <div class="col-md-2 pull-right">
         <a href="<?php echo e(url('/newMessage')); ?>">
           <img src="<?php echo e(Config::get('app.url')); ?>/public/img/compose.png" title="Send New Messages"></a>
       </div>
    </div>
     ...
     <li v-if="privsteMsg.status==1"  @click="messages(privsteMsg.id)" style="list-style:none;
      margin-top:10px; background-color:#F3F3F3" class="row">
        ...
        <div class="col-md-3 pull-left">
             <img :src="'<?php echo e(Config::get('app.url')); ?>/public/img/' + privsteMsg.pic"
   ...
   <div v-for="singleMsg in singleMsgs" >
    <div v-if="singleMsg.user_from == <?php echo Auth::user()->id; ?>">
      <div class="col-md-12" style="margin-top:10px">
        <img :src="'<?php echo e(Config::get('app.url')); ?>/public/img/' + singleMsg.pic"
