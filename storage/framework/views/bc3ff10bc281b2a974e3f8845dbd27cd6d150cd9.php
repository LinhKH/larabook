                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                            <?php echo e(config('app.name', 'LaraBook')); ?>
                              ...
                              <li><a href="<?php echo e(url('/requests')); ?>">My Requests
                                      <span style="color:green; font-weight:bold;
                                       font-size:16px">(<?php echo e(App\friendships::where('status', Null)
                                                  ...
                                                  ->count()); ?>)</span></a></li>
                        <li>  <a href="<?php echo e(url('jobs')); ?>"  style="background-color:#283E4A; color:#fff; padding:5px 15px 5px 15px; border-radius:5px; margin:8px">Find Job</a></li>
                            <?php endif; ?>
                        </ul>
                          ...
                          <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                               role="button" aria-expanded="false">
                                <img src="<?php echo e(Config::get('app.url')); ?>/public/img/msg_icon.png" width="30"/>
                                <span class="badge"
                                      style="background:red; position: relative; top: -15px; left:-10px">
                                      <?php echo $__env->make('profile.unread', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </span>
                            </a>
                                 ...
                                 <?php echo e(App\notifcations::where('status', 1)
                                   ...
                                   <ul class="dropdown-menu" role="menu" style="width:320px">
                                       <?php $__currentLoopData = $notes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <a href="<?php echo e(url('/notifications')); ?>/<?php echo e($note->id); ?>">
                                        ...
                                        <li style="background:#E4E9F2; padding:10px">
                                         ...
                                         <div class="row">
                                          <div class="col-md-2">
                                            <img src="<?php echo e(url('../')); ?>/public/img/<?php echo e($note->pic); ?>"
                                             style="width:50px; padding:5px; background:#fff; border:1px solid #eee" class="img-rounded">
                                          </div>

                                        <div class="col-md-10">

                                         <b style="color:green; font-size:90%"><?php echo e(ucwords($note->name)); ?></b>
                                          <span style="color:#000; font-size:90%"><?php echo e($note->note); ?></span>
                                          <br/>
                                          <small style="color:#90949C"> <i aria-hidden="true" class="fa fa-users"></i>
                                            <?php echo e(date('F j, Y', strtotime($note->created_at))); ?>

                                          at <?php echo e(date('H: i', strtotime($note->created_at))); ?></small>
                                        </div>
                    ...
                    <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                    <img src="<?php echo e(Config::get('app.url')); ?>/public/img/<?php echo e(Auth::user()->pic); ?>" width="30px" height="30px" class="img-circle"/>
