...
<head>
  ...
  <script type="text/javascript" src="https://use.fontawesome.com/595a5020bd.js"></script>
  ...
  <div id="app">
    <div class="top_bar">
      ...
      <div class="top-left links" style="float:left">
        <input type="text" class="form-control" placeholder="what are you looking for?" v-model="qry" v-on:keyup.enter="autoComplete" />
        <div class="panel-footer" v-if="posts.length" style="position:relative; z-index:1000; border:1px solid #ccc; background:#fff;">
          <p v-for="result in posts">
            <a :href="'<?php echo e(url('profile')); ?>/' +  result.slug">
              <b>{{result.name}} </b>
            </a>
          </p>
        </div>
    ...
    <div class="flex-center position-ref full-height">
      <div class="col-md-12 ">
        ...
        <div class="col-md-3 left-sidebar hidden-xs hidden-sm" style="position:fixed; left:10px">
          ...
          <ul>
            <li>
              <a href="<?php echo e(url('/profile')); ?>/<?php echo e(Auth::user()->slug); ?>"> <img src="<?php echo e(Config::get('app.url')); ?>/public/img/<?php echo e(Auth::user()->pic); ?>" width="32" style="margin:5px" />
                <?php echo e(Auth::user()->name); ?></a>
            </li>
            <li>
              <a href="<?php echo e(url('/')); ?>"> <img src="<?php echo e(Config::get('app.url')); ?>/public/img/news_feed.png" width="32" style="margin:5px" />
                News Feed</a>
            </li>
            <li>
              <a href="<?php echo e(url('/friends')); ?>"> <img src="<?php echo e(Config::get('app.url')); ?>/public/img/friends.png" width="32" style="margin:5px" />
                Friends </a>
            </li>
            <li>
              <a href="<?php echo e(url('/messages')); ?>"> <img src="<?php echo e(Config::get('app.url')); ?>/public/img/msg.png" width="32" style="margin:5px" />
                Messages</a>
            </li>
            <li>
              <a href="<?php echo e(url('/findFriends')); ?>"> <img src="<?php echo e(Config::get('app.url')); ?>/public/img/friends.png" width="32" style="margin:5px" />
                Find Friends</a>
            </li>

            <li>
              <a href="<?php echo e(url('/jobs')); ?>"> <img src="<?php echo e(Config::get('app.url')); ?>/public/img/jobs.png" width="32" style="margin:5px" />
                Find Jobs</a>
            </li>
          </ul>
            ...
            <div style="background-color:#fff; padding:10px">
              <div class="row">
                <div class="col-md-1 col-sm-2 pull-left">
                  <img src="<?php echo e(Config::get('app.url')); ?>/public/img/<?php echo e(Auth::user()->pic); ?>" style="width:50px; margin:5px;  border-radius:100%">
                </div>
                <div class="col-md-11 col-sm-10 pull-right">
                  <div v-if="!image">
                    <form method="post" enctype="multipart/form-data" v-on:submit.prevent="addPost">
                      <textarea style="resize:vertical" v-model="content" id="postText" class="form-control" placeholder="what's on your mind ?"></textarea>
            ...
            <div v-for="post,key in posts">
              ...
              <div class="col-md-12 all_posts">
                ...
                <div class="col-md-1 pull-left">
                  <img :src="'<?php echo e(Config::get('app.url')); ?>/public/img/' + post.user.pic" style="width:50px; border-radius:100%">
                </div>
                ...
                <p class="col-md-12" style="color:#000; margin-top:15px; font-family:inherit">
                  {{post.content}}
                  <br>
                  <img v-if="post.image" :src="'<?php echo e(Config::get('app.url')); ?>/public/img/' + post.image" style="width:100%" />
                </p>
              ...
              <div id="commentBox" v-if="commentSeen">
                ...
                <ul v-for="comment in post.comments">
                  <li v-if="comment.user_id==<?php echo e(Auth::user()->id); ?>">
                    <a href="<?php echo e(url('profile')); ?>">You</a>
                    {{comment.comment}}</li>
                  <li v-else>
                    <a :href="'<?php echo e(url('/profile')); ?>/' + post.user.slug">
                      {{post.user.name}}
                    </a>
                    {{comment.comment}}
                  </li>
